...
namespace Jiufen.Audio
{
    public static class AudioManager
    {
        ...
        #region 1.Fields
        public static Dictionary<string, AudioTrack> m_audioTable;
        ...
        private static void Configure()
        {
            ...
            m_audioTable = new Dictionary<string, AudioTrack>();
            GenerateAudioTable();
        ...
        private static void GenerateAudioTable()
        {
            foreach (AudioTrack tracks in m_audioTracks)
            {
                ...
                {
                    if (m_audioTable.ContainsKey(audioObj.key))
